...
REQUIRED_PATHS = [
    ...
    "models/almaty_v2/catboost_q10_price_per_m2_log.cbm",
    "models/almaty_v2/catboost_q50_price_per_m2_log.cbm",
    "models/almaty_v2/catboost_q90_price_per_m2_log.cbm",
    "models/almaty_v2/model_metadata.json",
    "models/almaty_v2/feature_config.json",
    "models/astana_v2/catboost_q10_price_per_m2_log.cbm",
    "models/astana_v2/catboost_q50_price_per_m2_log.cbm",
    "models/astana_v2/catboost_q90_price_per_m2_log.cbm",
    "models/astana_v2/model_metadata.json",
    "models/astana_v2/feature_config.json",
